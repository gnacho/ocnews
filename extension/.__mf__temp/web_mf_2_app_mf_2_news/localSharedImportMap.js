...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
      ...
      ,
        "@opencloud-eu/web-client/ox": async () => {
          throw new Error(`[Module Federation] Shared module '${"@opencloud-eu/web-client/ox"}' must be provided by host`);
        }
      ,
      ...
      const usedShared = {
        ...
        ,
          "@opencloud-eu/web-client/ox": {
            name: "@opencloud-eu/web-client/ox",
            version: undefined,
            scope: ["default"],
            loaded: false,
            from: "web-app-news",
            async get () {
              ...
              usedShared["@opencloud-eu/web-client/ox"].loaded = true
              const {"@opencloud-eu/web-client/ox": pkgDynamicImport} = importMap
              const res = await pkgDynamicImport()
              const exportModule = false && "@opencloud-eu/web-client/ox" === "react"
                ? (res?.default ?? res)
                : {...res}
              // All npm packages pre-built by vite will be converted to esm
              Object.defineProperty(exportModule, "__esModule", {
